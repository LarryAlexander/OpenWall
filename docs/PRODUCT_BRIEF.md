...
| Distribution         | Passed for MVP | The public repository and GitHub Pages demo are live through the approved deployment workflow.                             | Observe installation and offline use on target household hardware.           |
