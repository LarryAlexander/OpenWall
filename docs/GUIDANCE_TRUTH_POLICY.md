...
| ---------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Backups          | “Back up your entire board.”                  | Version 1 backups include the household, members, schedules, and tasks. Board layout, countdown cards, and Guide preferences remain outside the backup. |
...
| Device transfer  | “Restore everything on another device.”       | The current backup transfers household members, schedules, and tasks, but not the freeform board layout or countdowns.                                  |
| Photos           | “Add family photos.”                          | The current photo card is a visual placeholder until explicit local-file selection and durable permission handling are implemented.                     |
